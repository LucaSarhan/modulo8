...
def generate_launch_description():
    ...
    turtlebot3_gazebo_dir = get_package_share_directory('webots_ros2_turtlebot')
    turtlebot3_cartographer_dir = get_package_share_directory('turtlebot3_cartographer')
    
    # Command 1: Launch the turtlebot3_world
    turtlebot3_world_launch_file = os.path.join(turtlebot3_gazebo_dir, 'launch', 'robot_launch.py')
